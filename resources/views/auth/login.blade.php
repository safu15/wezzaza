            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form method="POST" action="{{ route('login') }}" id="formLoginRegister" enctype="multipart/form-data">
                ...
                <div class="alert alert-danger display-none mb-0 mt-3" id="errorLogin">
                    <ul class="list-unstyled m-0" id="showErrorsLogin">
<!--                        <li><button>Sign out &amp; Continue</button> <button>Okay</button></li>-->
                    </ul>
                  </div>
                  
<!--                  <button id="loginSessionCheck" class="btn btn-primary mt-4 w-100"><i></i> Sign out &amp; Continue</button>-->
