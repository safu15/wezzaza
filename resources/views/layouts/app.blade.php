...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="eventForm" aria-labelledby="mySmallModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="mySmallModalLabel">{{trans('general.create_event')}}</h5>
                    ...
                    <div class="modal-body p-0">
                        <div class="card bg-white shadow border-0">
                            ...
                            <div class="card-body px-lg-5 py-lg-5 position-relative">
                                ...
                                <!--                                 {{url('upload/eventimg')}}    <form action="" method="POST" id="formCover" accept-charset="UTF-8" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <input type="file" name="event" id="uploadEventImg" accept="image/*" class="visibility-hidden">
                                                                </form>-->

                                <!--                                <a href="javascript:;" class="position-absolute button-event-upload" onclick="$('#uploadEventImg').trigger('click');" id="event_file">
                                                                    <i class="fa fa-camera"></i>
                                                                </a>-->

                                <div class="alert alert-danger" style="display:none"></div>

                                <form method="post" action="{{url('upload/event')}}" id="formSendEvent" enctype="multipart/form-data">

                                    @csrf



                                    <b style="color: red;" id="event_image_error"></b>

                                    <div class="row">
                                        <div class="col-md-4 col-sm-4">
                                            <label class="mb-3" for="event_name" style=" padding: .625rem .75rem;">
                                                {{trans('general.upload_event_image')}} : 
                                            </label>
                                            <!--                                     d-lg-none  -->
                                            <a href="javascript:;" class="event_img position-absolute button-event-upload {{ auth()->check() && auth()->user()->dark_mode == 'on' ? 'image-dark' : 'image-light' }}" onclick="$('#uploadEventImg').trigger('click');" id="event_file" style="margin-left: 30px;z-index: 999;">
                                                <i class="fa fa-camera" style="font-size: 23px;"></i>
                                            </a>
                                        </div> 
                                        <!--                                        d-lg-block d-none  -->
                                        <div class="col-md-8 col-sm-8">   

                                            <!--                                            <a href="javascript:;" class="event_img position-absolute button-event-upload {{ auth()->check() && auth()->user()->dark_mode == 'on' ? 'image-dark' : 'image-light' }}" onclick="$('#uploadEventImg').trigger('click');" id="event_file">
                                                                                            <i class="fa fa-camera" style="font-size: 23px;"></i>
                                                                                        </a>-->

                                            <img src="" width="250" height="100" id="blah" style="display:none; margin-bottom: 8px;">
                                            
                                            <button class="img_remove_btn" style="display:none;" onclick="remove_event_img();">
                                    ...
                                    <input type="file" name="event_image" id="uploadEventImg" accept="image/*" class="visibility-hidden" onchange="return ValidateFileUpload()">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-sm-8">   
                                            <input type="text" id="event-name" name="event_name" class="form-control mb-3" placeholder="{{trans('general.event_name')}}"  required/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-sm-8">   
                                            <input type="text" id="start-date" name="start_date" class="form-control mb-3" placeholder="{{trans('general.start_time')}}"  required readonly/>
                                            <b style="color: red;" id="end_time_error"></b>
                                        </div>
                                    </div>
                                    <!--                                    <div class="row">
                                                                            <div class="col-md-4 col-sm-4">
                                                                                <label class="mb-3" for="end_date" style=" padding: .625rem .75rem;">
                                                                                    {{trans('general.end_time')}} : 
                                                                                </label>
                                                                            </div> 
                                                                            <div class="col-md-8 col-sm-8">   
                                                                                <input type="text" id="end-date" name="end_date" class="form-control mb-3" placeholder="{{trans('general.end_time')}}" required readonly/>
                                                                            </div>
                                                                        </div>-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-sm-8">   
                                            <select id="end-date" name="end_date" class="form-control browser-default mb-3" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-sm-8">   
                                            <input type="text" id="event-place" name="event_place" class="form-control mb-3" placeholder="{{trans('general.event_place')}}"  required/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4">
                                            <label class="mb-3" for="event_type" style=" padding: .625rem .75rem;">
                                                {{trans('general.event_type')}} : 
                                            </label>
                                        </div> 
                                        <div class="col-md-8 col-sm-8">   
                                            <select id="event-type" name="event_type" class="form-control browser-default mb-3" required>
                                    ...
                                    <div class="text-center">
                                        <button type="button" class="btn e-none mt-4" data-dismiss="modal">{{trans('admin.cancel')}}</button>
                                        <button type="submit" class="btn btn-primary mt-4" id="submitEvent"><i></i> {{trans('general.submit')}}</button>
                                    </div>
                                </form>
