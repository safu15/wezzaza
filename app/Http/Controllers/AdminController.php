...
class AdminController extends Controller
{
	...
	public function savePayments(Request $request)
	{
		...
		$sql->payout_method_fcib_pay = $request->payout_method_fcib_pay;
		$sql->payout_method_wise_payment = $request->payout_method_wise_payment;
		$sql->payout_method_bank_wire = $request->payout_method_bank_wire;
	...
	public function pwa(Request $request)
	{
        ...
        public function agora_key_modify(Request $request) {
        
            $sql = $this->settings;
		$sql->agora_app_id = $request->AGORA_APP_ID;
		$sql->agora_app_certificate = $request->AGORA_APP_CERTIFICATE;
		$sql->save();
...
//		}
    	...
    	return redirect('panel/admin/agora/key');
